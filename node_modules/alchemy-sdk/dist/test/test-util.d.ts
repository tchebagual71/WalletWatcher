...
export declare function createRawContractForOwner(address: string, tokenId: string, media: Media[], isSpam?: boolean, name?: string, tokenType?: NftTokenType, symbol?: string, totalSupply?: string, opensea?: RawOpenSeaCollectionMetadata, contractDeployer?: string, deployedBlockNumber?: number, title?: string): RawContractForOwner;
